        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    <a href="iklan" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Iklan</a>
    ...
    <div class="container-fluid bg-primary py-4 bg-header" style="margin-bottom: 80px;">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-4 text-white animated zoomIn">Jenis Iklan</h1>
                <a href="/" class="h5 text-white">Beranda</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="#" class="h5 text-white">Jenis Iklan</a>
            </div>
        </div>
    </div>
</div>
<!-- Navbar & Carousel End -->
        ...
        @include('iklan.pesanan.jenisiklan')
