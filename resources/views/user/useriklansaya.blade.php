                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                        @if(Auth::user()->level =='user')
                            ...
                            <a href="/iklansaya" class="dropdown-item active">Info Iklan Saya</a>
                        @endif
    ...
    <div class="container-fluid bg-primary py-4 bg-header" style="margin-bottom: 80px;">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-4 text-white animated zoomIn">Info Iklan</h1>
                <a href="/" class="h5 text-white">Beranda</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="#" class="h5 text-white">Info Iklan</a>
            </div>
        </div>
    </div>
</div>
<!-- Navbar & Carousel End -->
    ...
    @include('user.pesanan.iklansaya')
