...
<head>
    <meta charset="utf-8">
    <title>Info.co.id - Pembayaran</title>
    ...
    <div class="container-fluid bg-primary py-4 bg-header" style="margin-bottom: 80px;">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-4 text-white animated zoomIn">Pembayaran</h1>
                <a href="/iklansaya" class="h5 text-white">Iklan Saya</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="#" class="h5 text-white">Pembayaran</a>
            </div>
        </div>
    </div>
</div>
